...
export class SampleService extends ServiceBase {
  ...
  GetList(
    request: SampleGetListArg
  ): Observable<ResponseBase<SampleGetListResponse[]>> {
  ...
  GetData(
    request: SampleGetDataArg
  ): Observable<ResponseBase<SampleSaveDataArg>> {
  ...
  RemoveData(
    request: SampleRemoveDataArg
  ): Observable<ResponseBase<SampleRemoveDataResponse[]>> {
