...
export class UserService extends ServiceBase {
  ...
  getMenu(): Observable<ResponseBase<Menu>> {
    ...
    return this.http.post<ResponseBase<Menu>>(url, this.httpOptions)
  }

  getList(request: ShareRequest): Observable<ResponseBase<User[]>> {
    const url = `${this.baseUrl}/GetList`
    return this.http.post<ResponseBase<User[]>>(url, request, this.httpOptions)
  }
  ...
  getUserLog(request: ShareRequest): Observable<ResponseBase<UserLog[]>> {
    ...
    return this.http.post<ResponseBase<UserLog[]>>(url, request, this.httpOptions)
  }
}
