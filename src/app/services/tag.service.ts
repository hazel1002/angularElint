...
export class TagService extends ServiceBase {
  ...
  getList(request: ShareRequest): Observable<ResponseBase<Tag[]>> {
    ...
    return this.http.post<ResponseBase<Tag[]>>(url, request, this.httpOptions)
  }
  ...
  getAutocompleteList(request: ShareRequest): Observable<ResponseBase<AutocompleteTag[]>> {
    ...
    return this.http.post<ResponseBase<AutocompleteTag[]>>(url, request, this.httpOptions)
  }

  getAutocompleteByTagValueList(
    request: ShareRequest
  ): Observable<ResponseBase<AutocompleteTag[]>> {
