...
export class ReportService extends ServiceBase {
  ...
  getReportURL(request: ShareRequest): Observable<ResponseBase<Report>> {
    ...
    return this.http.post<ResponseBase<Report>>(url, request, this.httpOptions);
  }

  // 人營銷售漏斗分析
  getSalesFunnelReport(
    request: ShareRequest
  ): Observable<ResponseBase<Report>> {
