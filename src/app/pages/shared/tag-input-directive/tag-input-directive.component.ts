...
@Component({
  ...
  standalone: true,
  imports: [NbTagModule, NgFor, NbAutocompleteModule, FormsModule, NbOptionModule, AsyncPipe],
})
export class TagInputDirectiveComponent extends BaseComponent implements OnInit {
  ...
  constructor(private tagService: TagService, protected override allow: AllowHelper) {
    super(allow)
  }
