...
@Component({
  ...
  `,
  standalone: true,
  imports: [OneColumnLayoutComponent, NbMenuModule, RouterOutlet, NgxSpinnerModule],
})
export class PagesComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    console.log(
      '%cWelcome cdp',
      'color: green; font-family: sans-serif; font-size: 4.5em; font-weight: bolder; text-shadow: #000 1px 1px;'
    )
